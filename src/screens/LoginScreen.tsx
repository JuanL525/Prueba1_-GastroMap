...
export default function LoginScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white justify-center px-6">
      {/* Contenedor agrupador para mantener todo unido en el centro */}
      <View className="w-full">
        <Text className="text-3xl font-bold text-[#006491] mb-1 text-center">
          🍕 Gastro Map
        </Text>
        ...
        <Text
          className="text-center text-[#006491] mt-6 py-2 font-medium"
